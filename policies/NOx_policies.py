...
#             if g2 == g and m.tp_period[t] == p
#         ),
#         doc="Annual NOx emissions (tons) by emitting generator and period.",
#     )
...
#         ),
#         doc="Total NOx cost ($) across emitting generators for each period.",
#     )
...
def define_components(model):
    ...
    def AnnualNOx_by_gen_rule(m, g, p):
